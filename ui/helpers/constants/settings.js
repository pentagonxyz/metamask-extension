...
export const SETTINGS_CONSTANTS = [
  ...
  {
    tabMessage: (t) => t('networks'),
    sectionMessage: (t) => t('arbitrum'),
    descriptionMessage: (t) => t('arbitrum'),
    route: `${NETWORKS_ROUTE}#networks-arbitrum`,
    icon: 'fa fa-plug',
  },
  {
    tabMessage: (t) => t('networks'),
    sectionMessage: (t) => t('polygon'),
    descriptionMessage: (t) => t('polygon'),
    route: `${NETWORKS_ROUTE}#networks-polygon`,
    icon: 'fa fa-plug',
  },
  {
    tabMessage: (t) => t('networks'),
    sectionMessage: (t) => t('optimism'),
    descriptionMessage: (t) => t('optimism'),
    route: `${NETWORKS_ROUTE}#networks-optimism`,
    icon: 'fa fa-plug',
  },
  {
    tabMessage: (t) => t('networks'),
  ...
  {
    tabMessage: (t) => t('networks'),
    sectionMessage: (t) => t('arbitrumGoerli'),
    descriptionMessage: (t) => t('arbitrumGoerli'),
    route: `${NETWORKS_ROUTE}#networks-arbitrumGoerli`,
    icon: 'fa fa-plug',
  },
  {
    tabMessage: (t) => t('networks'),
    sectionMessage: (t) => t('polygonMumbai'),
    descriptionMessage: (t) => t('polygonMumbai'),
    route: `${NETWORKS_ROUTE}#networks-polygonMumbai`,
    icon: 'fa fa-plug',
  },
  {
    tabMessage: (t) => t('networks'),
